...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="min-h-screen flex items-center justify-center p-6 bg-background text-foreground font-sans antialiased">
        <div className="max-w-md w-full card p-8 text-center border-amber-500/30 bg-card shadow-2xl space-y-6 relative overflow-hidden">
